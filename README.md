...
3.Run command ,"php artisan serve".Then run, "php artisan queue:work".This will allow queue to start working.<br>
4.In separate terminal run command ,php artisan schedule:work.This will allow scheduled work to operate properly.<br>
Note:The commands should be entered in given order.<br>
For testing purpose use OPEN_APP_ID=9a701c3d88278d0ec38ef512f15f24be
